...
H₀: There is no significant difference in the distribution of [variable] between the early and late periods.

Results showed statistically significant differences (p < 0.05) for maximum temperature, minimum temperature, and air frost days, leading to rejection of the null hypothesis for those variables. Rainfall showed no significant difference, and sunshine hours produced a borderline result.
